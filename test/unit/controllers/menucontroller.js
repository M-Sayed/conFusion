describe('Controller: MenuController', function() {
  ...
  it('should have showDetails as false', function() {
    expect(scope.showDetails).toBeFalsey();
  });
  ...
  it('should create "dishes" with 2 dishes fetched from xhr', function(){
    ...
    expect(scope.dishes.lenght).toBe(2);
  });

  it('shold have the correct data order in the dishes', function(){
  ...
  it('should change the tab selected based on tab clicked', function() {
    ...
    expect(scope.fillText).toEqual("mains");
  });
});
